...
title = 'Transilio preserve'
track = 'resources/ogg/betteroffalone.ogg'
max_jump_tick = 46
...
data[']'] = {class = 'Text', text = 'It does not give you an extra double jump.', font = 'font_pixel_16', color = text_color, oy = -15}
data['{'] = {class = 'Text', text = 'That was far too easy...', font = 'font_pixel_16', color = u_text_color}
data['}'] = {class = 'Text', text = 'Ever heard of \'\'the golden mean\'\'?', font = 'font_pixel_16', color = text_color}
data['|'] = {class = 'Text', text = 'Someone is a big silly.', font = 'font_pixel_16', color = text_color}
